    ...
    <div className='bg-white p-4'>
      <div className="wrapper bg-[url(/Images/image.jpg)] h-[90vh] w-auto bg-center bg-cover bg-no-repeat flex flex-col items-center justify-center text-white text-center rounded-md gap-10">
        ...
        <div className='flex flex-row items-center justify-center gap-6'>
          <button onClick={()=> setShowForm(true)} className='py-2 px-6 bg-purple-100 border text-black rounded-full cursor-pointer text-transform uppercase font-semibold text-[8px]'>join the waitlist</button>
