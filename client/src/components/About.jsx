...
const About = ({setShowForm}) => {
  return (
    <div className='bg-white p-4 flex flex-col items-center justify-center gap-4'>
      <h4 className='text-lg font-semibold'>ABOUT DAMAC ISLAND</h4>
      <h2 className='text-4xl font-mono text-center'>A New Waterfront Master Community</h2>
      <p className='text-sm w-3/4 text-center'>Discover DAMAC Islands by DAMAC Properties. Imagine a place surrounded by serene waters and island beauty, where each day starts with the gentle sound of waves and ends with breathtaking views of the horizon. We've embraced the essence of island living to create a community dedicated to your well-being, where tranquility and luxury flow effortlessly together. Choose from exquisitely designed 4 and 5-bedroom townhouses within our exclusive collection of residences at DAMAC Islands, offering the perfect blend of elegance and coastal serenity.
      </p>
      <button onClick={()=> setShowForm(true)} className='py-2 px-6 bg-primary outline  text-secondary rounded-full cursor-pointer text-transform uppercase font-semibold text-[8px]'>GET THE BROCHURE</button>
