...
const About = () => {
  return (
    <div className='bg-white p-4 flex flex-col items-center justify-center gap-4'>
      ...
      <button className='py-2 px-6 bg-primary outline  text-secondary rounded-full cursor-pointer text-transform uppercase font-semibold text-[8px]'>GET THE BROCHURE</button>
